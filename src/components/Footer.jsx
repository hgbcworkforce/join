...
const Footer = () => {
  return (
    <footer className="relative bg-zinc-950 text-gray-400  pb-10">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-16 md:mt-32 border-t border-zinc-900 pt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm mb-4">Higher Ground Baptist Church, <br />Adekehin Close, Behind Alata Milk & Honey, Under G, Ogbomoso, Oyo State, Nigeria.</p>
            <a href="mailto:contacthgbc@gmail.com" className="text-orange-500 text-sm font-bold block mb-2">contacthgbc@gmail.com</a>
